...
figure6 <- function(fast=T) {
    if( fast ){
        print("Fast is TRUE so just load in simulated data without doing a new simulation.")
    }
    else{
...
triangleLooErr <- function(slope=0.2){
    load("./herm-elegans-connectomes/herm_Graph.Rd")
    Ag[Ag>0]=1
